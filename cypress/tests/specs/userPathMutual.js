...
describe('Mutual smoke test:', () => {
    it('Mutual user path:', { scrollBehavior: false }, () => {
        ...
        mutualPage.juridicalSwitchIsChecked().should('be.equal', true);
        mutualPage.IPSwitchIsChecked().should('be.equal', true);
        mutualPage.residentSwitchIsChecked().should('be.equal', true);
        ...
        const insuredFullName = ''.concat(JSONLoader.testData.insuredClientLastName, ' ',JSONLoader.testData.insuredClientFirstName, ' ', JSONLoader.testData.insuredClientMiddleName);
        ...
        mutualPage.experienceLessThan2YearsSwitchIsChecked().should('be.equal', true);
