...
class QuoteStep4 extends BaseForm {
  ...
  clickRandomSalesChannel(randomElementText) {
    ...
    this.#salesChannelsElements.chooseElementFromDropdown(
      randomElementText,
      { typeAndEnter: true },
    );
  }
  ...
  clickRandomChannelDetail(randomElementText) {
    ...
    this.#channelDetailsElements.chooseElementFromDropdown(
      randomElementText,
      { typeAndEnter: true },
    );
  }
  ...
  clickRandomInsuranceType(randomElementText) {
    ...
    this.#insuranceTypesElements.chooseElementFromDropdown(
      randomElementText,
      { typeAndEnter: true },
    );
  }
  ...
  clickRandomInsuredProduct(randomElementText) {
    ...
    this.#insuredProductsElements.chooseElementFromDropdown(
      randomElementText,
      { typeAndEnter: true },
    );
  }
